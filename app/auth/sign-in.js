  ...
  return (
    <main style={{ fontFamily: 'Roboto, Arial, sans-serif', background: '#f6fff6', minHeight: '100vh', color: '#222' }}>
      <div style={{ maxWidth: 400, margin: '0 auto', padding: '2rem', background: '#fff', borderRadius: 12, boxShadow: '0 2px 8px rgba(67,160,71,0.08)', border: '1px solid #e0f2f1' }}>
        <h1 style={{ color: '#43a047', fontWeight: 700, fontSize: '2rem', marginBottom: '1rem', textAlign: 'center' }}>Sign In</h1>
        ...
        <div style={{ margin: '1rem 0', textAlign: 'center' }}>
          <button type="button" onClick={() => handleSocialLogin('google')} style={{ background: '#fff', color: '#43a047', border: '1px solid #43a047', padding: '0.5rem 1rem', borderRadius: 8, fontWeight: 500, marginRight: 8, cursor: 'pointer' }}>Sign in with Google</button>
          <button type="button" onClick={() => handleSocialLogin('facebook')} style={{ background: '#fff', color: '#43a047', border: '1px solid #43a047', padding: '0.5rem 1rem', borderRadius: 8, fontWeight: 500, cursor: 'pointer' }}>Sign in with Facebook</button>
        </div>
        <div style={{ marginTop: '1rem', textAlign: 'center' }}>
          <a href="/auth/sign-up" style={{ color: '#43a047', textDecoration: 'underline' }}>Don't have an account? Sign Up</a>
        </div>
