  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-[70vh] bg-green-50">
      ...
      <section className="w-full max-w-xl mx-auto p-8 text-center bg-white rounded-xl shadow-md border border-green-100">
        ...
        <a href="/products" className="inline-block bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2">View Products</a>
      </section>
    </main>
  );
}
