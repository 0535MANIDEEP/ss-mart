...
export default function Footer() {
  return (
    <footer className="fixed bottom-0 left-0 w-full h-12 bg-green-50 dark:bg-gray-950 text-green-800 dark:text-gray-200 border-t border-green-100 dark:border-gray-800 flex items-center justify-center text-xs md:text-sm z-30 shadow-inner select-none transition-colors duration-300" role="contentinfo" aria-label="Site footer">
